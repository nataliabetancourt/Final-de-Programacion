...
boolean estado;
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 1025, 644);
		...
		lblNewLabel.setBounds(388, 79, 648, 560);
		...
		lblNewLabel_1.setBounds(306, 40, 629, 599);
		...
		lblNewLabel_2.setIcon(new ImageIcon(Game.class.getResource("/recurso/Inventario-03.png")));
		lblNewLabel_2.setBounds(607, 414, 199, 144);
